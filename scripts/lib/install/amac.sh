...
run_amac() {
  ...
  collect_install_options "winona" "a-mac" "winona" "winnie@winneon.moe" "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIClBpas/q9BP1YNEKQ1w7bHm2RjTJfIimOUWBHekHjoJ" "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIClBpas/q9BP1YNEKQ1w7bHm2RjTJfIimOUWBHekHjoJ" "" amac
...
note: Lix is preferred for the remaining bootstrap steps; plain Nix is only used if the Lix installer is unavailable.
  ...
  sudo env ANIX_INSTALL_OPTIONS_FILE="$ANIX_INSTALL_OPTIONS_FILE" nix run nix-darwin/master#darwin-rebuild -- --impure switch --flake "${repo_dir}#amac"
}
